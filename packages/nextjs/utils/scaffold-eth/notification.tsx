...
const Notification = ({
  ...
  return toast.custom(
    (t: Toast) => (
      <div
        className={`flex flex-row items-start justify-between max-w-sm rounded-xl shadow-center shadow-accent bg-[#0b1512] border border-[#39FF14] text-white p-4 transform-gpu relative transition-all duration-500 ease-in-out space-x-2
        ${
